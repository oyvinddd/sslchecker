...
const (
	...
	refreshTokenExpiration = time.Hour * 72
...
var (
	...
	// TODO: we need a way of distinguishing this app_error on the client, since we need to take special action
...
/*
func mappedError(err app_error) app_error {
